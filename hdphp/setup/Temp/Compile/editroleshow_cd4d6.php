...
<div class="hd_setup">
    ...
    <h2>
        <a href="http://localhost/ymweb/hdphp/setup/index.php?c=Rbac">返回安装首页</a>&nbsp;&nbsp;&nbsp;
        <a href="http://localhost/ymweb/hdphp/setup/index.php?c=Rbac/showrole" target="_self">查看用户组(角色)</a>&nbsp;&nbsp;&nbsp;
        <a href="javascript:void(0)" onclick="window.close();return false;">关闭</a>
        &nbsp;<a href="http://localhost/ymweb/hdphp/setup/index.php?c=Rbac/lock" >锁定SETUP应用</a>
    </h2>
</div>
